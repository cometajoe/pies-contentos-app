  ...
  <path d="M23,17.1c-2.3,2.3-5.2,4-8.3,4.7c-5.8,1.3-11.6-1.5-14.2-6.7c-0.4-0.8-0.2-1.8,0.6-2.2c0.8-0.4,1.8-0.2,2.2,0.6c1.9,3.9,6.2,5.8,10.5,4.9c2.4-0.5,4.6-2,6.4-3.9c0.6-0.6,1.6-0.6,2.2,0C23.6,15.5,23.6,16.5,23,17.1z"/>
        ...
        >
          ...
          >
            ...
            {t('hero.donateButton') || 'Dona Ahora'}
          ...
          <motion.a
            href="#about"
            className="group inline-flex items-center px-8 py-4 text-lg font-medium text-white border-2 border-white/30 hover:border-white/60 backdrop-blur-sm hover:bg-white/10 rounded-xl focus:outline-none focus:ring-4 focus:ring-white/20 transition-all duration-300"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
            {t('hero.learnMoreButton') || 'Conocer Más'}
            <svg className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
          <div className="text-center">
            <div className="text-3xl sm:text-4xl font-bold text-sky-400 mb-2">
              {t('hero.stat1Number') || '2,500+'}
            </div>
            <div className="text-sm sm:text-base text-slate-300">
              {t('hero.stat1Text') || 'Niños ayudados'}
            </div>
          </div>
          <div className="text-center">
            <div className="text-3xl sm:text-4xl font-bold text-sky-400 mb-2">
              {t('hero.stat2Number') || '50+'}
            </div>
            <div className="text-sm sm:text-base text-slate-300">
              {t('hero.stat2Text') || 'Comunidades'}
            </div>
          </div>
          <div className="text-center">
            <div className="text-3xl sm:text-4xl font-bold text-sky-400 mb-2">
              {t('hero.stat3Number') || '9'}
            </div>
            <div className="text-sm sm:text-base text-slate-300">
              {t('hero.stat3Text') || 'Años de impacto'}
            </div>
          </div>
        </motion.div>
      </motion.div>
      ...
      >
        ...
        >
          <span className="text-sm mb-2 font-light">
            {t('hero.scrollText') || 'Descubre más'}
          </span>
